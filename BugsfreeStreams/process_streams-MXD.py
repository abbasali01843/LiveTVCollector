...
# Source M3U playlist
SOURCES = [
    "https://raw.githubusercontent.com/abbasali01843/LiveTVCollector/main/LiveTV/Mixed/LiveTV.m3u",
]
FALLBACK_SOURCES = [
    "https://raw.githubusercontent.com/abbasali01843/LiveTVCollector/main/LiveTV/Mixed/LiveTV.m3u",
]
...
def main():
    ...
    for url, (extinf, original_url, variants, channel_name) in unique_streams.items():
        github_url = f"https://abbasali01843.github.io/{REPO_NAME}/BugsfreeStreams/StreamsTV-MXD/{channel_name}.m3u8"
