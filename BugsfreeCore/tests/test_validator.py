...
class ValidatorTests(unittest.TestCase):
    ...
    def test_app_exports_and_country_files(self):
        results = [
            {
                "name": "Active News", "url": "https://example.com/news.m3u8",
                "final_url": "https://cdn.example.com/news.m3u8", "logo": "https://example.com/news.png",
                "group": "News", "country": "Bangladesh", "source": "test",
                "status": "active", "protocol": "hls", "score": 100,
            },
            {
                "name": "Down Channel", "url": "https://example.com/down.m3u8",
                "final_url": "https://example.com/down.m3u8", "logo": "", "group": "News",
                "country": "Bangladesh", "source": "test", "status": "down", "protocol": "hls", "score": 0,
            },
            {
                "name": "Geo Channel", "url": "https://example.com/geo.m3u8",
                "final_url": "https://example.com/geo.m3u8", "logo": "", "group": "Sports",
                "country": "India", "source": "test", "status": "geo_or_restricted", "protocol": "hls", "score": 25,
            },
        ]
        with tempfile.TemporaryDirectory() as tmp:
            ...
            try:
                ...
                bd = json.loads((Path(tmp) / "countries" / "Bangladesh.json").read_text(encoding="utf-8"))
            finally:
        ...
        self.assertEqual(bd["country"], "Bangladesh")
